	...
	<div class="container">
        ...
        <?php
         ...
         $offset = ($page - 1) * $perPage; // Offset for pagination
          $blogs = $db->select('blogs','*',null,"title LIKE '%$search%' OR blog LIKE '%$search%' AND deleted_at IS NULL",null,$perPage,$offset);
        ?>
        ...
        <?php endforeach; ?>
          ...
          <?php $db->links('blogs',"title LIKE '%$search%' OR blog LIKE '%$search%' AND deleted_at IS NULL") ?>
