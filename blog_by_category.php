	...
	<div class="container">
        ...
        $cat_id_s = $_GET['search']; 
         ...
         $offseta = ($pagea - 1) * $Pagelimit; // Offset for pagination
          $blogs = $db->select('blogs','*',null,"cat_id=$cat_id_s AND deleted_at IS NULL",null,$Pagelimit,$offseta);
        ?>
        ...
        <?php endforeach; ?>
          <?php $db->links('blogs',"cat_id=$cat_id_s AND deleted_at IS NULL") ?>
